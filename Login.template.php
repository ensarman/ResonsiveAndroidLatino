...
function template_login()
{
        ...
        <div class="card">
          <div class="card-main">
            <div class="card-inner">
                        ...
                        <h3 class="catbg">
                            <span class="icon">input</span>', $txt['login'], '
                        </h3>
                        
                        <span class="upperframe"><span></span></span>
                        <div class="roundframe"></div>';
	...
	echo '
                        <div class="form-group form-group-label">
                          <label class="floating-label" for="username">', $txt['username'], ':</label>
                          <input class="form-control input_text" id="username" type="text" name="user" size="20" value="', $context['default_username'], '" />
                        </div>
                        <div class="form-group form-group-label">
                          <label class="floating-label" for="password">', $txt['password'], ':</label>
                          <input type="password" name="passwrd" value="', $context['default_password'], '" class="form-control input_password" id="password"/>
                        </div>';
	...
	echo '
                        <div class="form-group form-group-label">
                          <label class="floating-label" for="mins-logged">', $txt['mins_logged_in'], ':</label>
                          <input type="text" name="cookielength" size="4" maxlength="4" value="', $modSettings['cookieTime'], '"', $context['never_expire'] ? ' disabled="disabled"' : '', ' class=" form-control input_text" id="mins-logged"/>
                        </div>
                        <div class="checkbox checkbox-adv">
                            <label for="always-logged">
                                <input class="access-hide input_check" id="always-logged" type="checkbox" name="cookieneverexp"', $context['never_expire'] ? ' checked="checked"' : '', ' onclick="this.form.cookielength.disabled = this.checked;" />
